      ...
      <!--[if (gte mso 9)|(IE)]>
        <table border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
            ...
            <![endif]-->
              <singleline>
                <a href="#" mc:edit data-button data-text-style="Intro Button" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:18px;line-height:28px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 16px 38px 16px 38px;display: inline-block;"><span>GET STARTED</span></a>
              </singleline>
            <!--[if (gte mso 9)|(IE)]>
            </td>
            <td align="center" width="38"></td>
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="580" style="width:580px;max-width:580px;" data-module="black-fwd-image-1">
  ...
  <tr data-element="black-intro-1-image" data-label="Image">
    <td align="center" class="img-responsive">
      <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;" data-image-edit data-url data-label="Image" width="580" src="images/fwd-image-1.jpg" border="0" editable="true" alt="picture">
    </td>
  </tr>
  <tr>
    <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing bottom">&nbsp;</td>
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="580" style="width:580px;max-width:580px;" data-module="black-step-1">
        ...
        <tr>
          <td class="rwd-col" align="center">
            ...
            <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="center-float"> 
              <tr>
                <td align="center">
                  <img style="width:52px;border:0px;display: inline!important;" src="images/account-icon.png" width="52" border="0" editable="true" data-icon data-image-edit data-url data-label="Icon" alt="icon">
                </td>
              </tr>
            </table>
  ...
  <tr data-element="black-step-1-paragraph" data-label="Paragraphs">
    <td data-text-style="Paragraphs" align="center" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:18px;line-height:32px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
        <singleline>
          <div mc:edit data-text-edit>
            Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi accus antium iste natus. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.
          </div>
        </singleline>
    </td>
  </tr>
        ...
        <tr>
          <td class="rwd-col" align="center">
            ...
            <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="center-float"> 
              <tr>
                <td align="center">
                  <img style="width:52px;border:0px;display: inline!important;" src="images/skills-icon.png" width="52" border="0" editable="true" data-icon data-image-edit data-url data-label="Icon" alt="icon">
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td class="rwd-col" align="center">
            ...
            <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="center-float"> 
              <tr>
                <td align="center">
                  <img style="width:52px;border:0px;display: inline!important;" src="images/post-icon.png" width="52" border="0" editable="true" data-icon data-image-edit data-url data-label="Icon" alt="icon">
                </td>
              </tr>
            </table>
